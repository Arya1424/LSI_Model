...
class LstmNet(torch.nn.Module):
    ...
    def forward(self, inputs, mask=None): # [B, S, H], [B, S]
        ...
        pck_inputs = torch.nn.utils.rnn.pack_padded_sequence(inputs, lengths, batch_first=True, enforce_sorted=False)
